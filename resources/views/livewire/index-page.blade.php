    ...
    <div class="section py-16" id="Galleri">
        <div class="container mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div class="mb-4">
                    <div class="card rounded-lg overflow-hidden">
                        <img src="{{ asset('img/bg.jpg') }}" class="card-img-top" alt="Galleri2">
                    </div>
                </div>
                <div class="mb-4">
                    <div class="card rounded-lg overflow-hidden">
                        <img src="{{ asset('img/bg.jpg') }}" class="card-img-top" alt="Galleri3">
                    </div>
                </div>
                <div class="mb-4">
                    <div class="card rounded-lg overflow-hidden">
                        <img src="{{ asset('img/bg.jpg') }}" class="card-img-top" alt="Galleri4">
                    </div>
                </div>
            </div>
        </div>
